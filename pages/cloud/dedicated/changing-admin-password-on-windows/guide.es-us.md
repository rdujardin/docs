...
El sistema debe arrancarse en modo de rescate antes de poder cambiar la contraseña de administrador. Conéctese al [área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager), acceda a la sección Cloud de la `bare metal`{.action} y seleccione el servidor en la lista de navegación de la izquierda en `servidores dedicados`{.action}.
...
En primer lugar, sustituya el netboot por **Booter en el disco duro** en el [área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager) (ver [Etape 1](./#1-reiniciar-el-servidor-en-modo-de-rescate_1)). 
...
En primer lugar, sustituya el netboot por **Booter en el disco duro** en el [área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager) (ver [Etape 1](./#etape-1-redemarrer-le-serveur-en-mode-rescue_1)).
