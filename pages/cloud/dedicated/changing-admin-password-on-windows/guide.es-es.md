...
El sistema debe arrancarse en modo de rescate antes de poder cambiar la contraseña de administrador. Conéctese al [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager), acceda a la sección Cloud de la `bare metal`{.action} y seleccione el servidor en la lista de navegación de la izquierda en `servidores dedicados`{.action}.
...
Una vez que haya realizado los cambios, haga clic en `...`{.action} a la derecha de "Status" en la zona titulada **Estado de los servicios**.
...
Conéctese al servidor por SSH. Si fuera necesario, consulte la guía. 
<br>Dado que se trata de un servidor Windows, las particiones se titularán "Microsoft LDM data".

```
# fdisk -l
Disk /dev/sda: 1.8 TiB, 200398934016 bytes, 3907029168 sectores
Units: sectoriales of 1 * 512 = 512 bytes
...
Failed to mount '/dev/sda4': Operación not permited
...
chntpw versión 1.00 140201, (c) Petter N Hagen
Hive <SAM> name (from header): <\SystemRoot\System32\Config\SAM>
ROOT KEY at offset: 0x001020 * Subkey indexing type is: 686c <lh>
File size 65536 [1000] bytes, containing 8 páginas (+ 1 headerpage)
...
En primer lugar, sustituya el netboot por **Booter en el disco duro** en el [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager) (ver [Etape 1](./#1-reiniciar-el-servidor-en-modo-de-rescate_1)). 
...
¡El sistema se gobierna por una nueva época!
```
...
Para más información sobre el modo de rescate, consulte [esta guía](../ovh-rescue/).
...
En primer lugar, sustituya el netboot por **Booter en el disco duro** en el [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager) (ver [Etape 1](./#etape-1-redemarrer-le-serveur-en-mode-rescue_1)).
...
Continúe leyendo esta guía en el [apartado 5\. establecer una nueva contraseña (IPMI)](./#etape-5-definir-un-nouveau-mot-de-passe-ipmi).
